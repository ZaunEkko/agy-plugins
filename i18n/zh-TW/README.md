...
| 插件 | 類型 | 說明 | 文件 |
|------|------|------|------|
| explanatory-output-style | Plugin + PreInvocation Hook | 將 Claude Code 官方 explanatory-output-style 體驗適配到 Antigravity。 | [插件文件](docs/explanatory-output-style/README.md) |
